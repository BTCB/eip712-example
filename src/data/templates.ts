...
const batchTransferSample = {
  ...
  types: {
    ...
    BatchTransfer: [
      ...
      { name: 'fixedByte1Array', type: 'bytes1[]' },
      { name: 'fixedByte4Array', type: 'bytes4[]' },
      { name: 'fixedByte8Array', type: 'bytes8[]' },
      { name: 'fixedByte16Array', type: 'bytes16[]' },
  ...
  message: {
    ...
    fixedByte1: '0x12',
    fixedByte4: '0x1234',
    fixedByte8: '0x12345678',
    fixedByte16: '0x1234567890abcdef1234567890abcdef1234567890abcdef',
    fixedByte32: '0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef',
    fixedByte1Array: ['0x12', '0x34', '0x56'],
    fixedByte4Array: ['0x1234', '0x5678', '0x90ab'],
    fixedByte8Array: ['0x12345678', '0x90ab', '0xcdef'],
    fixedByte16Array: [
